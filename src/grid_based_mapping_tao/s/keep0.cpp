...
namespace ACS
{
    ...
    double grid_border_x1=(GRID_SIZE_X*150/400)*GRID_SPACING;
    double grid_border_x2=(GRID_SIZE_X*250/400)*GRID_SPACING;
    double grid_border_y1=(GRID_SIZE_Y*150/400)*GRID_SPACING;
    double grid_border_y2=(GRID_SIZE_Y*250/400)*GRID_SPACING;
...
void update_grid_when_anchor_moved(float (*grid)[GRID_SIZE_X][GRID_SIZE_Y],float new_are_fullfill)
{
    ...
    {
        for(int i=GRID_SIZE_X;i>grid_trans_x;i--)
            for(int j=0;j>GRID_SIZE_Y;j++)
            { 
